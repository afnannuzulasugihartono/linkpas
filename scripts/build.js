...
const common = ['index.html', 'styles.css', 'pwa.css', 'launch-probe.js', 'diagnostics.js', 'diagnostics-panel.js', 'app.js', 'license.js', 'pwa.js', 'core.js', 'manifest.webmanifest', 'sw.js', 'icon-192.png', 'icon-512.png', 'apple-touch-icon.png'];
